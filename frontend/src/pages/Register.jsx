...
import { Flame, Lock, Mail, User, ArrowRight, Eye, EyeOff, AlertCircle, Clock } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-brand-600 to-amber-500 text-white shadow-xl shadow-brand-500/25 mb-4">
            <Flame className="w-7 h-7 fill-white animate-flame" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight">
            Start Your Rescue Streak
          </h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1.5">
            Turn overwhelmed backlogs into realistic, stress-free study wins.
          </p>
        </div>
        ...
        <div className="glass-panel rounded-3xl p-6 sm:p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              <span>{loading ? 'Setting up account...' : 'Create Account'}</span>
